...
ld.id="custom-loader";
ld.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:#000 url('loading.png') center center no-repeat;background-size:contain;z-index:9999;";
